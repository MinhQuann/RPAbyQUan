...
TH_Contact_0CRM_0CORE_1
    ...
    RPACallAPI_CALL_CTI    12345541    8010    RINGING    1    0906453315
    Sleep    2s
    ${all_tab}=    RPA.Browser.Selenium.Get Window Handles
    RPA.Browser.Selenium.Switch Window    ${original_tab}[0]
    RPACallAPI_CALL_CTI    12345541    8010    ANSWER    1    0906453315
    Sleep    1s
    Edit_New_Cus_Name
    EditContactInfo
    Sleep    3s
    Add_New_Ticket_History
    RPACallAPI_CALL_CTI    12345541    8010    SUCCCESS    1    0906453315
